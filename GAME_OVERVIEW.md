...
- index 1〜19: **PLR02〜PLR20** — 過去に章 20 を制覇して現世に帰還した先代旅人 19 体。1 周クリア毎に順次アンロック。
- index 20: **🌟 PLR01 英霊ハルキ** — PLR00 で章 20 をクリアすると解放される **未来の英霊化したハルキ自身**。真エンディングルートの主役。
...
Epilogue             PLR02〜PLR20 が順次アンロック (= 先代の英霊召喚)
```
...
- `unlockedCount` (0..20) — そのスロットでアンロック済の PLR 数
