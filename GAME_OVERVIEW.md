...
- index 1〜19: **PLR02〜PLR20** — 過去に章 20 を制覇して現世に帰還した先代旅人 19 体。**v0.36.40 以降 (Design A): 各 PLR は自身の章 1-20 lap を全走する**。スロットごとに、現在 active な PLR で章 20 を制覇すると次の chain step PLR が自動的に序章 (ch.0) に切替わる。PLR00 → PLR02 → PLR03 → … → PLR20 → PLR01 の AVATARS 配列順チェーン。総完走 = 約 421 試合 (PLR00 lap 20 + PLR02..PLR20 各 20 + PLR01 lap 21)。
...
Epilogue (Design A)  PLR00 章 1-20 完走 → PLR02 lap 序章 → PLR02 章 1-20 → ...
                      → PLR20 章 1-20 → PLR01 lap 序章 → PLR01 章 1-20 → 真ED
                      (chain advance ごとに storyProgress=0 へリセット)
```
