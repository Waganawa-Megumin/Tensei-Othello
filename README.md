...
> **Summoned as an Othello Player** — 異界『盤上世界』に呼ばれて挑む 20 章のオセロアドベンチャー
...
| 用途 | 表記 | 説明 |
|---|---|---|
| **アプリ／作品タイトル** | 召喚されたらオセロ世界でした！ | ラノベ風のメタタイトル。タイトル画面・README・ブラウザタブ |
| **作中異界の名前** | 盤上世界（ばんじょうせかい）/ Bansho Sekai | プレイヤーが召喚される世界の固有名詞。ストーリー文・章説明 |

英語表記が必要なときは:
- 作品: **Summoned as an Othello Player**
- 異界: 訳さず **Bansho Sekai**

> 旧称「転生したらオセロ世界でした！ / Reincarnated as an Othello Player」(v0.31 まで) からは v0.32.4 で「召喚」路線に振り替えています。リポジトリ名 `Tensei-Othello` は引き続き残してありますが、新規の文章では必ず「召喚 / Summoned」を使ってください。
