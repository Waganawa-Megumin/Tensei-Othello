# CLAUDE.md — 転生したらオセロ世界でした！ プロジェクトハンドオフ
...
**コアコンセプト**: 「転生したらオセロ世界でした！」 —— ライトノベル風の異世界転生もの。プレイヤーは異界『盤上世界』に転生し、20人の達人を順に打ち破ってエンディングを目指す。各達人は剣士・魔術師・侍・ハッカーなど、ファンタジー〜現代〜SFを横断する多様な世界観。
...
| 用途 | 表記 | 説明 |
|---|---|---|
| **アプリ/作品タイトル** | 転生したらオセロ世界でした！ | ラノベ風のメタタイトル。タイトル画面、README、ブラウザタブで使用 |
| **作中世界の名前（固有名詞）** | 盤上世界（ばんじょうせかい）/ Bansho Sekai | プレイヤーが転生する異界の名前。ストーリー文・章説明・ナラティブテキストで言及 |

英語表記が必要なときは:
- 作品: **Reincarnated as an Othello Player**（タイトル画面サブタイトル）
...
| #  | 名前      | 主人公アーキタイプ        | ファイル                              |
|----|-----------|---------------------------|---------------------------------------|
| 1  | ハルキ    | 異世界転生の勇者          | players/01_haruki.png                 |
...
### 優先度: 中
- 駒を置く効果音、ヒット音、勝利ファンファーレ
- AI 思考中のサブイル UI 改善（現状ただ「…」表示）
- ストーリー章クリア時のアニメーション演出
- スマホ縦長時のレイアウト調整（特に設定モーダル内のキャラグリッド）

### 優先度: 低
- 評価関数を本格化（Edax の評価値テーブル等の導入）
