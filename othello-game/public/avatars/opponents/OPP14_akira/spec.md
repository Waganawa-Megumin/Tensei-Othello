...
| アーキタイプ (日本語) | 探偵 |
| アーキタイプ (英語) | Detective |
| 難易度レベル (Story Mode) | Lv.14 |
| 名言 (日本語) | 「君の手筋、見えているよ」 |
| 名言 (英語) | "Your moves are showing through." |

## キャラクターデザイン (維持ポイント)

新規生成・差し替え時の正の記述。

> Brown checkered/plaid deerstalker hat, dark brown short tousled hair, sharp keen blue eyes, white shirt with brown checkered tie, dark checkered waistcoat, beige trench coat with high collar, BLACK leather gloves holding ornate gold-rimmed magnifying glass. Sherlockian sleuth.
...
虫眼鏡レンズが「描かれたガラス感」で不透明。完全な透明化は意図的に行っていない (要望があればレンズ部分のみ強制透明化処理が可能)。
