...
| アーキタイプ (日本語) | 吟遊詩人 |
| アーキタイプ (英語) | Bard |
| 難易度レベル (Story Mode) | Lv.5 |
| 名言 (日本語) | 「楽しい一局を奏でよう♪」 |
| 名言 (英語) | "Let's compose a fun match♪" |

## キャラクターデザイン (維持ポイント)

新規生成・差し替え時の正の記述。

> Bright golden-blonde wavy hair, green beret with gold trim adorned with a blue gem and white feather, warm brown eyes, big cheerful smile, white frilly cravat, dark coat with green cloak (gold trim and blue gem at the closure), holding wooden lute/mandolin. Warm troubadour.
