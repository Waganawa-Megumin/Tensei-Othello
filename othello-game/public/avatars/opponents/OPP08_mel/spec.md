...
| アーキタイプ (日本語) | 錬金術師 |
| アーキタイプ (英語) | Alchemist |
| 難易度レベル (Story Mode) | Lv.8 |
| 名言 (日本語) | 「ふふ、ちょっと混ぜてみよっか？」 |
| 名言 (英語) | "Hehe, let's mix it up a bit?" |

## キャラクターデザイン (維持ポイント)

新規生成・差し替え時の正の記述。

> Long sage-green wavy hair with side braid, large GOLD METAL HEADBAND ornament (NOT a witch hat), gold round-rimmed glasses, golden-yellow eyes, soft smile, white high-collared shirt under green corset/bodice with elaborate gold filigree, brown leather alchemy backpack with multiple flask-tubes (green liquid) on her back, holding a bubbling green Erlenmeyer flask. Bookish alchemist (NOT a witch).
...
持っているフラスコの透明部分は Adobe 透過処理で適切に半透明になっている。
