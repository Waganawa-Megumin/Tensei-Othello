/**
 * PLR04 Ren (kendo team captain, Mutoukan) — English story package.
 *
 * Co-located with `public/illustrations/PLR04_ren/`, `./ja.ts`,
 * `./index.ts`.
 *
 ...
 *   - prologue       : en.ts:1603-1891 (prologueByPlr[3])
 *   - chapters 1..20 : en.ts:3010-3778 (chapterStoriesByPlr[3])
 *   - narrative      : en.ts:1042-1259 (narrativeByPlr[3])
 *   - chainStepEnding: en.ts:1336-1458 (chainStepEndingByPlr[3])
 */
import type { PlrPackage } from '../../types';
import { ch } from '../../utils';

export const PLR04_REN_EN: PlrPackage = {
  plrIdx: 3,
