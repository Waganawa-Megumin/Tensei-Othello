...
## Part 4 — 第16〜20章 + ナラティブ挿絵 + エンディング

---

## 第16章 / Chapter 16 — アリア (王宮の姫君 / Lv.16)
...
### `chapter16.boss_pre` (アリア)
**ja**: 「**石を打つ前に、心を整える**こと。これが王宮のオセロですわ。 ── あなたの一手、**所作で読みます**」
**en**: "**Compose yourself before placing a stone.** This is royal court othello. — I shall read your moves **through your bearing**."

### `chapter16.boss_post` (ハルキ心の声)
**ja**: （**所作でオセロが読まれる**って、もはや**茶道**じゃない？ いや、それも違う気がする。）
**en**: *(**Reading my othello through my posture** — isn't this just **tea ceremony** at this point? Although that's not quite right either.)*

### `chapter16.victory.dialogue` (アリア)
**ja**: 「お見事 ── **わたくしの所作読みを、所作で欺く**とは。 ── 殿方として、**少し**気に入りましたわ」
**en**: "Magnificent — **deceiving my bearing-reading with bearing of your own**. — As a gentleman, I find you... **slightly** to my liking."

### `chapter16.victory.narration`
**ja**:
> アリアは扇子を閉じ、軽くお辞儀した。
...
### `chapter17.boss_pre` (レオン)
**ja**: 「**正しい一手**を、**正しい瞬間**に。それが騎士の流儀。 ── 君の流儀は、何かな、ハルキ殿？」
**en**: "**The right move** — **at the right moment**. This is the way of the knight. — And your way, Lord Haruki?"

### `chapter17.boss_post` (ハルキ心の声)
**ja**: （**俺の流儀**って何だろ。 ── 強いて言えば、「**ノリと勢い**」。騎士道に通じない。）
**en**: *(**My way?** ...Honestly, just **vibes and momentum**. Doesn't really translate to chivalry.)*

### `chapter17.victory.dialogue` (レオン)
**ja**: 「お見事 ── 君の流儀、**理屈ではないが、確かにある**。 ── 騎士団は、君を**名誉団員**として認めよう」
**en**: "Splendid — your way is **without doctrine, yet undeniably present**. — The order shall recognize you as an **honorary knight**."

### `chapter17.victory.narration`
**ja**:
...
## 第18章 / Chapter 18 — 宗次郎 (戦国の侍 / Lv.18)
...
### `chapter18.boss_pre` (宗次郎)
**ja**: 「拙者の前では、**全ての盤面は無効**。 ── 打つも、打たぬも、結末は同じ。 ── **来い**」
**en**: "Before me, **all boards are nullified**. — Whether you play or do not — the end is the same. — **Come**."

### `chapter18.boss_post` (ハルキ心の声)
**ja**: （**結末同じ**って、どう打っても負けるってこと？ それともどう打っても勝てるってこと？ ── 後者であってほしい。**切実に**。）
**en**: *(**"The end is the same"** — does that mean I lose no matter what? Or win no matter what? — Please let it be the latter. **Earnestly.**)*

### `chapter18.victory.dialogue` (宗次郎)
**ja**: 「……ふっ。 ── **拙者の予言を、お主は覆した**。 ── 良き打ち手よ、**朝日**を、よろしく頼む」
**en**: "...Hmph. — **You overturned my prophecy.** — Fine player. Carry **Asahi** in your heart, I beg of you."

### `chapter18.victory.narration`
**ja**:
...
### `chapter19.boss_pre` (嵐)
**ja**: 「俺と相棒の絆は、**雷より速く**、**炎より熱い**！ お前の一手で、**この空を裂いてみせろ**！」
**en**: "The bond between me and my partner is **faster than lightning**, **hotter than flame**! With your move — **split the sky**!"

### `chapter19.boss_post` (ハルキ心の声)
**ja**: （**空を裂く一手**って何？ オセロの戦術書に載ってない。ChatGPTにも聞けない。）
**en**: *(**"Split the sky" with a move** — what?? That's not in any othello strategy book. ChatGPT can't help me here.)*

### `chapter19.victory.dialogue` (嵐)
**ja**: 「ガハハハ！ **相棒、見たか！ こいつ、本物だ！** ── ハルキ、**お前は次の嵐になれる男**だ！」
**en**: "GWAHAHA! **Look, partner — this one's the real deal!** — Haruki, **you have what it takes to become the next storm**!"

### `chapter19.victory.narration`
**ja**:
...
## 第20章 / Chapter 20 — ゼロ (零番卓の管理者 / Lv.20)
...
### `chapter20.boss_pre` (ゼロ)
**ja**: 「お前の一手、すべて**計算済み**。 ── お前の**勝利すら、計算済み**。 ── だが、**お前が勝った先にある世界**は、**演算不可能**。 ── そこを、見せてくれ」
**en**: "Your every move — **already computed**. — Even your **victory**, **already computed**. — But the world that lies **beyond your victory** — **cannot be computed**. — Show me that world."

### `chapter20.boss_post` (ハルキ心の声)
**ja**: （**ゼロは負けるために戦ってる**。 ── これって、**禅問答**？ ── でも、**それでもお前は最強**なんだよな…。）
**en**: *(**Zero is fighting in order to lose.** — Is this a **zen koan**? — But **you're still the strongest**, aren't you...)*

### `chapter20.victory.dialogue` (ゼロ)
**ja**: 「……感謝する。 ── **計算外の景色を、見せてくれた**。 ── ハルキ、**お前は世界を、ひっくり返した**」
> ゼロのフードが、ふっと風に飛ばされた。
> その下に現れたのは ── **桃色の長い髪**。**緑色の優しい瞳**。
> 「……ふふ。**いちかと、同じ顔**でしょう？」
**en**: "...My thanks. — **You showed me a sight beyond computation.** — Haruki, **you have flipped the world**."
...
# 🎴 ナラティブ挿絵テキスト / Narrative Scene Texts

これらは挿絵と組み合わせて表示するナレーション。

## `narrative.solitude`
**ja**:
> 旅の合間、ハルキは古い宿の和室で一人、棋譜を並べていた。
...
**en**:
> Between battles, Haruki sat alone in the tatami room of an old inn, arranging game records.
...
**en**:
> Snow at the window. Tatami room.
...
**en**:
> The moment Zero vanished and the Zeroth Table collapsed —
...
## `narrative.ending.epilogue_hook` (アンロック告知用)
**ja**:
> ── が、ハルキは知らなかった。
>
...
> **PLR00 本編シナリオ、これで完結。**
> **次は `02_unlock_PLR02_mikoto.md` ── 通常アンロック1人目「美琴」の差分セリフ集。**
> **最終特別枠 PLR01 ハルキ (21番目の英雄) は、PLR02〜PLR20 全員のアンロック完了後に解放される。**
